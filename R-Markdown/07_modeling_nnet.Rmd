...
| Model 3: | Differencing based on Model 1 training data split               | .59      | .57      |
| Model 4: | Random sample from differenced of the entire simulation         | .59      | .59      |
...
General Model Form:
nnet(Texting ~ Subject + Age + Gender + Anger + Contempt + Disgust + Fear + Joy + Sad + Surprise + Neutral)
